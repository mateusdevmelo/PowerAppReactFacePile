...
export class ReactFacePile implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    private theComponent: ComponentFramework.ReactControl<IInputs, IOutputs>;
    private notifyOutputChanged: () => void;

    private props: IFacepileBasicExampleProps = {
        numberFacesChanged: this.numberFacesChanged.bind(this),
        numberOfFaces: DEFAULT_NUMBER_OF_FACES, // Initialize numberOfFaces here
    };
    /**
     * Empty constructor.
     */
